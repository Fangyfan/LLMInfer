...
def parse_args():
    ...
    parser.add_argument("-p", "--checkpoint", type=str, default="/home/yifanfang/LLMInfer/models/qwen3/qwen3_0.6b_weights.pth",
                        help="Model checkpoint file path.")
    parser.add_argument("-d", "--device", type=str, default="cpu", help="Running model on which device")
    parser.add_argument("-n", "--model_name", type=str, default="/home/yifanfang/LLMInfer/models/qwen3", help="Which official model to use")
